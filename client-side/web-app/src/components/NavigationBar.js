...
export default function NavigationBar(props) {
  ...
  return (
    // <>
    //   <Navbar collapseOnSelect variant='dark' bg="inherit" >
    ...
    //         <Nav.Link className="text-white font-weight-bold Button-secondary mr-2" href='/home'>Sign in</Nav.Link>
    //         <Nav.Link className="text-white font-weight-bold Button-primary ml-2" style={{backgroundColor: 'inherit'}} href='/tracks'>Sign up</Nav.Link>
    //       </Nav>
